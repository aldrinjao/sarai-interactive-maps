...
@Component({
  selector: 'app-evi-filter-form',
  templateUrl: './evi-filter-form.component.html',
  styleUrls: ['./evi-filter-form.component.sass']
})
export class EviFilterFormComponent implements OnInit {
  ...
  processRequest() {
    ...
    // create the url tree
    urlTree = this._router.createUrlTree(['/evi', value.startDate, value.endDate], urlExtras);
